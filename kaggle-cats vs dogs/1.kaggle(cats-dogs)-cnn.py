...
history = model.fit_generator(train_generator, steps_per_epoch=2000//batch_size, epochs=3, validation_data=validation_generator, 
...
probabilities = model.predict_generator(test_generator, 40//(batch_size))
